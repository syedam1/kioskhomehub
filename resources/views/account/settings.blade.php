          ...
          <div class="col-lg-8 order-lg-1">
            ...
            <div class="card">
              ...
              <div class="card-body">
                ...
                <button type="button" class="btn btn-sm btn-secondary rounded-pill" data-toggle="modal" data-target="#modal-change-username">Change username</button>
                <!-- Modal -->
                    ...
                    <form>
                      <div class="modal-content">
                        ...
                        <div class="modal-footer">
                          <button type="button" class="btn btn-sm btn-secondary rounded-pill" data-dismiss="modal">Change my username</button>
                        </div>
                      </div>
                    </form>
                  </div>
                    ...
                    <form class="form-danger">
                      <div class="modal-content">
                        <div class="modal-body">
                          ...
                          <div class="mt-4">
                            <button type="button" class="btn btn-block btn-sm btn-white text-danger rounded-pill">Delete my account</button>
