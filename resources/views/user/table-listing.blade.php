            ...
            <table class="table align-items-center">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>
                    <div style="max-width: 100px;">
                      <div class="spark-chart" data-toggle="spark-chart" data-type="line" data-height="30" data-color=warning data-dataset="[58, 76, 13, 59, 17, 76, 13, 13, 21, 94, 49]"></div>
                    </div>
                  </td>
                  <td class="text-right">
                    <!-- Actions -->
                ...
                <tr>
                  ...
                  <td>
                    <div style="max-width: 100px;">
                      <div class="spark-chart" data-toggle="spark-chart" data-type="line" data-height="30" data-color=primary data-dataset="[42, 55, 19, 16, 84, 24, 10, 11, 93, 15, 81]"></div>
                    </div>
                  </td>
                  <td class="text-right">
                    <!-- Actions -->
                ...
                <tr>
                  ...
                  <td>
                    <div style="max-width: 100px;">
                      <div class="spark-chart" data-toggle="spark-chart" data-type="line" data-height="30" data-color=info data-dataset="[25, 66, 41, 89, 63, 25, 44, 12, 36, 9, 54]"></div>
                    </div>
                  </td>
                  <td class="text-right">
                    <!-- Actions -->
                ...
                <tr>
                  ...
                  <td>
                    <div style="max-width: 100px;">
                      <div class="spark-chart" data-toggle="spark-chart" data-type="line" data-height="30" data-color=primary data-dataset="[51, 61, 45, 66, 48, 40, 68, 83, 27, 78, 48]"></div>
                    </div>
                  </td>
                  <td class="text-right">
                    <!-- Actions -->
                ...
                <tr>
                  ...
                  <td>
                    <div style="max-width: 100px;">
                      <div class="spark-chart" data-toggle="spark-chart" data-type="line" data-height="30" data-color=success data-dataset="[94, 34, 96, 74, 36, 97, 15, 26, 54, 97, 23]"></div>
                    </div>
                  </td>
                  <td class="text-right">
                    <!-- Actions -->
                ...
                <tr>
                  ...
                  <td>
                    <div style="max-width: 100px;">
                      <div class="spark-chart" data-toggle="spark-chart" data-type="line" data-height="30" data-color=danger data-dataset="[64, 56, 61, 42, 42, 63, 18, 96, 19, 36, 87]"></div>
                    </div>
                  </td>
                  <td class="text-right">
                    <!-- Actions -->
                ...
                <tr>
                  ...
                  <td>
                    <div style="max-width: 100px;">
                      <div class="spark-chart" data-toggle="spark-chart" data-type="line" data-height="30" data-color=primary data-dataset="[98, 25, 62, 42, 94, 65, 21, 85, 76, 86, 41]"></div>
                    </div>
                  </td>
                  <td class="text-right">
                    <!-- Actions -->
