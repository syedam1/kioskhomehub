  ...
  <div class="container-fluid container-application">
    ...
    <div class="sidenav" id="sidenav-main">
      ...
      <div class="nav-application clearfix">
        ...
        <a href="../../application/user/card-listing.blade.php" class="btn btn-square text-sm active">
        ...
        <div class="row">
                ...
                <div class="row justify-content-between align-items-center">
                  <div class="col-6">
                    <div style="max-width: 120px;">
                      <div class="spark-chart" data-toggle="spark-chart" data-type="line" data-height="50" data-color=success data-dataset="[47, 94, 24, 18, 26, 65, 31, 47, 10, 44, 45]"></div>
                    </div>
                  </div>
          ...
          <div class="col-lg-3 col-sm-6">
            <div class="card hover-shadow-lg">
              <div class="card-body text-center">
                <div class="avatar-parent-child">
                  <img alt="Image placeholder" src="../../assets/img/theme/light/team-2-800x800.jpg" class="avatar  rounded-circle avatar-lg">
                  <span class="avatar-child avatar-badge bg-warning"></span>
                </div>
              ...
              <div class="card-body border-top">
                <div class="row justify-content-between align-items-center">
                  <div class="col-6">
                    <div style="max-width: 120px;">
                      <div class="spark-chart" data-toggle="spark-chart" data-type="line" data-height="50" data-color=warning data-dataset="[58, 76, 13, 59, 17, 76, 13, 13, 21, 94, 49]"></div>
                    </div>
                  </div>
                  <div class="col-auto text-center">
          ...
          <div class="col-lg-3 col-sm-6">
            <div class="card hover-shadow-lg">
              <div class="card-body text-center">
                <div class="avatar-parent-child">
                  <img alt="Image placeholder" src="../../assets/img/theme/light/team-3-800x800.jpg" class="avatar  rounded-circle avatar-lg">
          ...
          <div class="col-lg-3 col-sm-6">
            <div class="card hover-shadow-lg">
              <div class="card-body text-center">
                <div class="avatar-parent-child">
                  <img alt="Image placeholder" src="../../assets/img/theme/light/team-4-800x800.jpg" class="avatar  rounded-circle avatar-lg">
                  <span class="avatar-child avatar-badge bg-success"></span>
                </div>
              ...
              <div class="card-body border-top">
                <div class="row justify-content-between align-items-center">
                  <div class="col-6">
                    <div style="max-width: 120px;">
                      <div class="spark-chart" data-toggle="spark-chart" data-type="line" data-height="50" data-color=success data-dataset="[25, 66, 41, 89, 63, 25, 44, 12, 36, 9, 54]"></div>
                    </div>
                  </div>
                  <div class="col-auto text-center">
          ...
          <div class="col-lg-3 col-sm-6">
            <div class="card hover-shadow-lg">
              <div class="card-body text-center">
                <div class="avatar-parent-child">
                  <img alt="Image placeholder" src="../../assets/img/theme/light/team-5-800x800.jpg" class="avatar  rounded-circle avatar-lg">
                  <span class="avatar-child avatar-badge bg-success"></span>
                </div>
              ...
              <div class="card-body border-top">
                <div class="row justify-content-between align-items-center">
                  <div class="col-6">
                    <div style="max-width: 120px;">
                      <div class="spark-chart" data-toggle="spark-chart" data-type="line" data-height="50" data-color=success data-dataset="[51, 61, 45, 66, 48, 40, 68, 83, 27, 78, 48]"></div>
                    </div>
                  </div>
                  <div class="col-auto text-center">
            ...
            <div class="card hover-shadow-lg">
              ...
              <div class="card-body border-top">
                <div class="row justify-content-between align-items-center">
                  <div class="col-6">
                    <div style="max-width: 120px;">
                      <div class="spark-chart" data-toggle="spark-chart" data-type="line" data-height="50" data-color=success data-dataset="[94, 34, 96, 74, 36, 97, 15, 26, 54, 97, 23]"></div>
                    </div>
                  </div>
                  <div class="col-auto text-center">
            ...
            <div class="card hover-shadow-lg">
              ...
              <div class="card-body border-top">
                <div class="row justify-content-between align-items-center">
                  <div class="col-6">
                    <div style="max-width: 120px;">
                      <div class="spark-chart" data-toggle="spark-chart" data-type="line" data-height="50" data-color=warning data-dataset="[64, 56, 61, 42, 42, 63, 18, 96, 19, 36, 87]"></div>
                    </div>
                  </div>
                  <div class="col-auto text-center">
            ...
            <div class="card hover-shadow-lg">
              ...
              <div class="card-body border-top">
                <div class="row justify-content-between align-items-center">
                  <div class="col-6">
                    <div style="max-width: 120px;">
                      <div class="spark-chart" data-toggle="spark-chart" data-type="line" data-height="50" data-color=danger data-dataset="[98, 25, 62, 42, 94, 65, 21, 85, 76, 86, 41]"></div>
                    </div>
                  </div>
                  <div class="col-auto text-center">
            ...
            <div class="card hover-shadow-lg">
              ...
              <div class="card-body border-top">
                <div class="row justify-content-between align-items-center">
                  <div class="col-6">
                    <div style="max-width: 120px;">
                      <div class="spark-chart" data-toggle="spark-chart" data-type="line" data-height="50" data-color=success data-dataset="[59, 100, 13, 50, 77, 33, 60, 22, 59, 68, 74]"></div>
                    </div>
                  </div>
                  <div class="col-auto text-center">
            ...
            <div class="card hover-shadow-lg">
              ...
              <div class="card-body border-top">
                <div class="row justify-content-between align-items-center">
                  <div class="col-6">
                    <div style="max-width: 120px;">
                      <div class="spark-chart" data-toggle="spark-chart" data-type="line" data-height="50" data-color=success data-dataset="[58, 76, 13, 59, 17, 76, 13, 13, 21, 94, 49]"></div>
                    </div>
                  </div>
                  <div class="col-auto text-center">
