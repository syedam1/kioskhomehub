  ...
  <div class="container-fluid container-application">
    ...
    <div class="sidenav" id="sidenav-main">
      ...
      <div class="nav-application clearfix">
        ...
        <a href="../../application/shop/invoices.blade.php" class="btn btn-square text-sm active">
            ...
            <div class="card hover-shadow-lg">
              ...
              <div class="card-body pt-0">
                ...
                <div class="media mt-4 align-items-center">
                  ...
                  <div class="media-body pl-3">
                    <div class="text-sm my-0">John Mayer <a href="#" class="text-primary font-weight-600">@dribbble</a></div>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div class="col-lg-4">
            <div class="card hover-shadow-lg">
              ...
              <div class="card-body pt-0">
                ...
                <div class="media mt-4 align-items-center">
                  <img alt="Image placeholder" src="../../assets/img/theme/light/brand-avatar-5.png" class="avatar  rounded-circle avatar-sm">
                  <div class="media-body pl-3">
                    <div class="text-sm my-0">John Mayer <a href="#" class="text-primary font-weight-600">@dribbble</a></div>
                  </div>
                </div>
          ...
          <div class="col-lg-4">
            <div class="card hover-shadow-lg">
              ...
              <div class="card-body pt-0">
                ...
                <div class="media mt-4 align-items-center">
                  <img alt="Image placeholder" src="../../assets/img/theme/light/brand-avatar-6.png" class="avatar  rounded-circle avatar-sm">
                  <div class="media-body pl-3">
                    <div class="text-sm my-0">John Mayer <a href="#" class="text-primary font-weight-600">@dribbble</a></div>
                  </div>
                </div>
