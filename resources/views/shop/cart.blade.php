            ...
            <table class="table align-items-center">
              ...
              <tbody class="list">
                <tr>
                  <th scope="row">
                    <div class="media align-items-center">
                      <img alt="Image placeholder" src="../../assets/img/theme/light/product-1.png" class="" style="width: 80px;">
                ...
                <tr>
                  <th scope="row">
                    <div class="media align-items-center">
                      <img alt="Image placeholder" src="../../assets/img/theme/light/product-2.png" class="" style="width: 80px;">
                      <div class="media-body pl-3">
                        <div class="lh-100">
                ...
                <tr>
                  <th scope="row">
                    <div class="media align-items-center">
                      <img alt="Image placeholder" src="../../assets/img/theme/light/product-3.png" class="" style="width: 80px;">
                      <div class="media-body pl-3">
                        <div class="lh-100">
                ...
                <tr>
                  <th scope="row">
                    <div class="media align-items-center">
                      <img alt="Image placeholder" src="../../assets/img/theme/light/product-4.png" class="" style="width: 80px;">
                      <div class="media-body pl-3">
                        <div class="lh-100">
                ...
                <tr>
                  <th scope="row">
                    <div class="media align-items-center">
                      <img alt="Image placeholder" src="../../assets/img/theme/light/product-5.png" class="" style="width: 80px;">
                      <div class="media-body pl-3">
                        <div class="lh-100">
                  ...
                  <td>
                    <input type="text" class="form-control form-control-sm text-center" style="width: 80px;" value="2">
                  </td>
                  <td class="total">
                    $78 USD
                  </td>
                ...
                <tr>
                  <th scope="row">
                    <div class="media align-items-center">
                      <img alt="Image placeholder" src="../../assets/img/theme/light/product-6.png" class="" style="width: 80px;">
                      <div class="media-body pl-3">
                        <div class="lh-100">
                ...
                <tr>
                  <th scope="row">
                    <div class="media align-items-center">
                      <img alt="Image placeholder" src="../../assets/img/theme/light/product-7.png" class="" style="width: 80px;">
                      <div class="media-body pl-3">
                        <div class="lh-100">
                ...
                <tr>
                  ...
                  <td>
                    <input type="text" class="form-control form-control-sm text-center" style="width: 80px;" value="100">
                  </td>
                  <td class="total">
                    $6500 USD
                  </td>
                ...
                <tr>
                  <th scope="row">
                    <div class="media align-items-center">
                      <img alt="Image placeholder" src="../../assets/img/theme/light/product-8.png" class="" style="width: 80px;">
                      <div class="media-body pl-3">
                        <div class="lh-100">
                  ...
                  <td>
                    <input type="text" class="form-control form-control-sm text-center" style="width: 80px;" value="300">
                  </td>
                  <td class="total">
                    $14700 USD
                  </td>
