            ...
            <div class="card hover-shadow-lg">
              ...
              <div class="card-body">
                ...
                <div class="w-100 pt-3">
                  <div class="spark-chart" data-toggle="spark-chart" data-color=primary data-dataset="[47, 94, 24, 18, 26, 65, 31, 47, 10, 44, 45]"></div>
                </div>
              </div>
          ...
          <div class="col-lg-3 col-sm-6">
            <div class="card hover-shadow-lg">
              ...
              <div class="card-body">
                ...
                <div class="w-100 pt-3">
                  <div class="spark-chart" data-toggle="spark-chart" data-color=warning data-dataset="[58, 76, 13, 59, 17, 76, 13, 13, 21, 94, 49]"></div>
                </div>
              </div>
              <div class="card-footer">
                <div class="actions d-flex justify-content-between">
          ...
          <div class="col-lg-3 col-sm-6">
            <div class="card hover-shadow-lg">
              ...
              <div class="card-body">
                ...
                <div class="w-100 pt-3">
                  <div class="spark-chart" data-toggle="spark-chart" data-color=info data-dataset="[42, 55, 19, 16, 84, 24, 10, 11, 93, 15, 81]"></div>
                </div>
              </div>
              <div class="card-footer">
                <div class="actions d-flex justify-content-between">
          ...
          <div class="col-lg-3 col-sm-6">
            <div class="card hover-shadow-lg">
              ...
              <div class="card-body">
                ...
                <div class="w-100 pt-3">
                  <div class="spark-chart" data-toggle="spark-chart" data-color=danger data-dataset="[25, 66, 41, 89, 63, 25, 44, 12, 36, 9, 54]"></div>
                </div>
              </div>
              <div class="card-footer">
                <div class="actions d-flex justify-content-between">
          ...
          <div class="col-lg-3 col-sm-6">
            <div class="card hover-shadow-lg">
              ...
              <div class="card-body">
                ...
                <div class="w-100 pt-3">
                  <div class="spark-chart" data-toggle="spark-chart" data-color=success data-dataset="[51, 61, 45, 66, 48, 40, 68, 83, 27, 78, 48]"></div>
                </div>
              </div>
              <div class="card-footer">
                <div class="actions d-flex justify-content-between">
          ...
          <div class="col-lg-3 col-sm-6">
            <div class="card hover-shadow-lg">
              ...
              <div class="card-body">
                ...
                <div class="w-100 pt-3">
                  <div class="spark-chart" data-toggle="spark-chart" data-color=primary data-dataset="[94, 34, 96, 74, 36, 97, 15, 26, 54, 97, 23]"></div>
                </div>
              </div>
              <div class="card-footer">
                <div class="actions d-flex justify-content-between">
          ...
          <div class="col-lg-3 col-sm-6">
            <div class="card hover-shadow-lg">
              <div class="card-header">
                <div class="d-flex align-items-center">
                  <div class="avatar-parent-child">
                    <img alt="Image placeholder" src="../../assets/img/theme/light/brand-avatar-7.png" class="avatar  rounded-circle">
                    <span class="avatar-child avatar-badge bg-info"></span>
                  </div>
                  <div class="avatar-content ml-3">
              ...
              <div class="card-body">
                ...
                <div class="w-100 pt-3">
                  <div class="spark-chart" data-toggle="spark-chart" data-color=primary data-dataset="[64, 56, 61, 42, 42, 63, 18, 96, 19, 36, 87]"></div>
                </div>
              </div>
              <div class="card-footer">
                <div class="actions d-flex justify-content-between">
          ...
          <div class="col-lg-3 col-sm-6">
            <div class="card hover-shadow-lg">
              <div class="card-header">
                <div class="d-flex align-items-center">
                  <div class="avatar-parent-child">
                    <img alt="Image placeholder" src="../../assets/img/theme/light/brand-avatar-8.png" class="avatar  rounded-circle">
                    <span class="avatar-child avatar-badge bg-info"></span>
                  </div>
                  <div class="avatar-content ml-3">
              ...
              <div class="card-body">
                ...
                <div class="w-100 pt-3">
                  <div class="spark-chart" data-toggle="spark-chart" data-color=info data-dataset="[98, 25, 62, 42, 94, 65, 21, 85, 76, 86, 41]"></div>
                </div>
              </div>
              <div class="card-footer">
                <div class="actions d-flex justify-content-between">
          ...
          <div class="col-lg-3 col-sm-6">
            <div class="card hover-shadow-lg">
              <div class="card-header">
                <div class="d-flex align-items-center">
                  <div class="avatar-parent-child">
                    <img alt="Image placeholder" src="../../assets/img/theme/light/brand-avatar-9.png" class="avatar  rounded-circle">
                    <span class="avatar-child avatar-badge bg-info"></span>
                  </div>
                  <div class="avatar-content ml-3">
              ...
              <div class="card-body">
                ...
                <div class="w-100 pt-3">
                  <div class="spark-chart" data-toggle="spark-chart" data-color=warning data-dataset="[59, 100, 13, 50, 77, 33, 60, 22, 59, 68, 74]"></div>
                </div>
              </div>
              <div class="card-footer">
                <div class="actions d-flex justify-content-between">
          ...
          <div class="col-lg-3 col-sm-6">
            <div class="card hover-shadow-lg">
              <div class="card-header">
                <div class="d-flex align-items-center">
                  <div class="avatar-parent-child">
                    <img alt="Image placeholder" src="../../assets/img/theme/light/brand-avatar-10.png" class="avatar  rounded-circle">
                    <span class="avatar-child avatar-badge bg-info"></span>
                  </div>
                  <div class="avatar-content ml-3">
              ...
              <div class="card-body">
                ...
                <div class="w-100 pt-3">
                  <div class="spark-chart" data-toggle="spark-chart" data-color=success data-dataset="[47, 94, 24, 18, 26, 65, 31, 47, 10, 44, 45]"></div>
                </div>
              </div>
              <div class="card-footer">
                <div class="actions d-flex justify-content-between">
          ...
          <div class="col-lg-3 col-sm-6">
            <div class="card hover-shadow-lg">
              <div class="card-header">
                <div class="d-flex align-items-center">
                  <div class="avatar-parent-child">
                    <img alt="Image placeholder" src="../../assets/img/theme/light/brand-avatar-11.png" class="avatar  rounded-circle">
                    <span class="avatar-child avatar-badge bg-info"></span>
                  </div>
                  <div class="avatar-content ml-3">
              ...
              <div class="card-body">
                ...
                <div class="w-100 pt-3">
                  <div class="spark-chart" data-toggle="spark-chart" data-color=danger data-dataset="[58, 76, 13, 59, 17, 76, 13, 13, 21, 94, 49]"></div>
                </div>
              </div>
              <div class="card-footer">
                <div class="actions d-flex justify-content-between">
          ...
          <div class="col-lg-3 col-sm-6">
            <div class="card hover-shadow-lg">
              <div class="card-header">
                <div class="d-flex align-items-center">
                  <div class="avatar-parent-child">
                    <img alt="Image placeholder" src="../../assets/img/theme/light/brand-avatar-12.png" class="avatar  rounded-circle">
                    <span class="avatar-child avatar-badge bg-info"></span>
                  </div>
                  <div class="avatar-content ml-3">
