  ...
  <div class="container-fluid container-application">
    ...
    <div class="sidenav" id="sidenav-main">
      ...
      <div class="nav-application clearfix">
        ...
        <a href="../../application/task/table-listing.blade.php" class="btn btn-square text-sm active">
              ...
              <div class="modal-header row">
                ...
                <div class="col-auto">
                  <div class="actions text-right">
                    <a href="#" class="action-item action-favorite active" data-toggle="tooltip" data-original-title="Mark as favorite">
                ...
                <div class="list-group list-group-flush mb-0">
                  <div class="list-group-item px-0">
                    <div class="row align-items-center">
                      ...
                      <div class="col ml-n2">
                        <a href="#!" class="d-block h6 text-sm font-weight-light mb-0">Martin added a new task to <strong>To Do</strong> list</a>
                  ...
                  <div class="list-group-item px-0">
                    <div class="row align-items-center">
                      ...
                      <div class="col ml-n2">
                        <a href="#!" class="d-block h6 text-sm font-weight-light mb-0">Jessie added <strong>Checklist</strong> to this card</a>
                  ...
                  <div class="list-group-item px-0">
                    <div class="row align-items-center">
                      ...
                      <div class="col ml-n2">
                        <a href="#!" class="d-block h6 text-sm font-weight-light mb-0">Martin added <strong>Jessie</strong> to the team</a>
        ...
        <div class="page-title">
          <div class="row justify-content-between align-items-center">
            <div class="col-md-6 d-flex align-items-center justify-content-between justify-content-md-start mb-3 mb-md-0">
              ...
              <!-- Optional link -->
              <a href="kanban-board.blade.php" class="text-sm text-info d-none d-lg-inline-block ml-4">Kanban Board</a>
            </div>
          ...
          <div class="card-body">
            ...
            <div class="mb-5" id="card-list-1">
                ...
                <div class="card-body row align-items-center">
                  ...
                  <div class="col-auto card-meta d-inline-flex align-items-center ml-sm-auto">
                    ...
                    <div class="media media-pill align-items-center d-inline-flex bg-secondary">
                      ...
                      <div class="ml-2">
                        <a href="#modal-users" class="mb-0 text-sm text-muted stretched-link" data-toggle="modal">+3</a>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div class="card card-progress border shadow-none draggable-item">
                ...
                <div class="card-body row align-items-center">
                  <div class="col-sm-6">
                    <a class="h6" href="#modal-task-view" data-toggle="modal">Create the login and register with Laravel</a>
                    <div class="actions d-inline-block float-right float-sm-none">
                      <div class="action-item ml-4">
                        <i class="fas fa-comment-alt mr-2"></i>6
                      </div>
            ...
            <div class="mb-5" id="card-list-2">
              <div class="card card-progress border shadow-none draggable-item">
                ...
                <div class="card-body row align-items-center">
                  <div class="col-sm-6">
                    <a class="h6" href="#modal-task-view" data-toggle="modal">Set up the marketplace strategy</a>
                    <div class="actions d-inline-block float-right float-sm-none">
                      <div class="action-item ml-4">
                        <i class="fas fa-comment-alt mr-2"></i>6
                      </div>
              ...
              <div class="card card-progress border shadow-none draggable-item">
                ...
                <div class="card-body row align-items-center">
                  <div class="col-sm-6">
                    <a class="h6" href="#modal-task-view" data-toggle="modal">Create the Facebook campaign setup</a>
                    <div class="actions d-inline-block float-right float-sm-none">
                      <div class="action-item ml-4">
                        <i class="fas fa-comment-alt mr-2"></i>6
                      </div>
              ...
              <div class="card card-progress border shadow-none draggable-item">
                ...
                <div class="card-body row align-items-center">
                  <div class="col-sm-6">
                    <a class="h6" href="#modal-task-view" data-toggle="modal">Compose newsletter for the big launch</a>
                    <div class="actions d-inline-block float-right float-sm-none">
                      <div class="action-item ml-4">
                        <i class="fas fa-comment-alt mr-2"></i>6
                      </div>
