  ...
  <div class="container-fluid container-application">
    ...
    <div class="sidenav" id="sidenav-main">
      ...
      <div class="nav-application clearfix">
        ...
        <a href="../../application/task/kanban-board.blade.php" class="btn btn-square text-sm active">
      ...
      <div class="page-content">
        ...
        <div class="card overflow-hidden">
          <div class="container-kanban">
            <div class="kanban-board" data-toggle="dragula" data-containers='["kanban-blacklist", "kanban-to-do", "kanban-in-progress", "kanban-testing", "kanban-done"]'>
                ...
                <div class="card-list card-list-flush">
                  <div class="card-list-title row align-items-center mb-3">
                    ...
                    <div class="col text-right">
                      <div class="actions">
                        <a class="action-item mr-2" href="#modal-task-create" data-toggle="modal"><i class="fas fa-plus"></i></a>
                        <div class="dropdown" data-toggle="dropdown">
                          <a href="#" class="action-item" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            <i class="fas fa-ellipsis-h"></i>
                          </a>
