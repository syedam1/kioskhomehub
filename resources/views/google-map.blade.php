          ...
          <div class="row justify-content-between align-items-center">
            <div class="col-md-6 d-flex align-items-center justify-content-between justify-content-md-start mb-3 mb-md-0">
              ...
              <div class="d-inline-block">
                <h5 class="h4 d-inline-block font-weight-400 mb-0 text-white">Google Map</h5>
              </div>
              <!-- Additional info -->
            </div>
          ...
          <div class="row no-gutters">
            <div class="col-lg-5 col-xl-4 order-lg-2">
              <div class="card-header actions-toolbar">
                ...
                <div class="row justify-content-between align-items-center">
                  <div class="col">
                    <h6 class="d-inline-block mb-0">Filters</h6>
                  </div>
                ...
                <li class="list-group-item">
                  <div class="row align-items-center">
                    ...
                    <div class="col-6 text-right">
                      <span class="badge badge-soft-success badge-pill">Yes</span>
                    </div>
                  </div>
                </li>
                <li class="list-group-item">
                  <div class="row align-items-center">
                    ...
                    <div class="col-6 text-right">
                      <span class="badge badge-soft-danger badge-pill">No</span>
                    </div>
                  </div>
                </li>
                <li class="list-group-item">
              ...
              <!-- Results -->
              <div class="border-bottom" style="height: 400px;">
                <div class="scrollbar-inner">
                  <div class="list-group list-group-flush">
                      ...
                      <div class="row align-items-center">
                        ...
                        <div class="col-auto">
                          <div class="custom-control custom-checkbox">
                            <input type="checkbox" class="custom-control-input" id="location-check-1" checked>
                            <label class="custom-control-label" for="location-check-1"></label>
                          </div>
                        </div>
                      </div>
                    </div>
                    <div class="list-group-item">
                      <div class="row align-items-center">
                        ...
                        <div class="col-auto">
                          <div class="custom-control custom-checkbox">
                            <input type="checkbox" class="custom-control-input" id="location-check-2">
                            <label class="custom-control-label" for="location-check-2"></label>
                          </div>
                        </div>
                      </div>
                    </div>
                    <div class="list-group-item">
                      <div class="row align-items-center">
                        ...
                        <div class="col-auto">
                          <div class="custom-control custom-checkbox">
                            <input type="checkbox" class="custom-control-input" id="location-check-3" checked>
                            <label class="custom-control-label" for="location-check-3"></label>
                          </div>
                        </div>
                      </div>
                    </div>
                    <div class="list-group-item">
                      <div class="row align-items-center">
                        ...
                        <div class="col-auto">
                          <div class="custom-control custom-checkbox">
                            <input type="checkbox" class="custom-control-input" id="location-check-4" checked>
                            <label class="custom-control-label" for="location-check-4"></label>
                          </div>
                        </div>
                      </div>
                    </div>
                    <div class="list-group-item">
                      <div class="row align-items-center">
                        ...
                        <div class="col ml-n2">
                          <a href="#!" class="d-block h6 mb-0">Mike Snow</a>
                          <p class="card-text text-sm text-muted mb-0">
                            14.0 km
                          </p>
                        </div>
                        <div class="col-auto">
                          <div class="custom-control custom-checkbox">
                            <input type="checkbox" class="custom-control-input" id="location-check-5" checked>
                            <label class="custom-control-label" for="location-check-5"></label>
                          </div>
                        </div>
                      </div>
                    </div>
                    <div class="list-group-item">
                      <div class="row align-items-center">
                        ...
                        <div class="col-auto">
                          <div class="custom-control custom-checkbox">
                            <input type="checkbox" class="custom-control-input" id="location-check-6" checked>
                            <label class="custom-control-label" for="location-check-6"></label>
                          </div>
                        </div>
                      </div>
                    </div>
                    <div class="list-group-item">
                      <div class="row align-items-center">
                        <div class="col-auto">
                          <!-- Avatar -->
                          <a href="#" class="avatar rounded-circle">
                            <img alt="Image placeholder" src="../assets/img/theme/light/team-7-800x800.jpg" class="">
                          </a>
                        </div>
                        <div class="col ml-n2">
                          <a href="#!" class="d-block h6 mb-0">John Sullivan</a>
                        ...
                        <div class="col-auto">
                          <div class="custom-control custom-checkbox">
                            <input type="checkbox" class="custom-control-input" id="location-check-7" checked>
                            <label class="custom-control-label" for="location-check-7"></label>
                          </div>
                        </div>
                      </div>
                    </div>
                    <div class="list-group-item">
                      <div class="row align-items-center">
                        ...
                        <div class="col-auto">
                          <div class="custom-control custom-checkbox">
                            <input type="checkbox" class="custom-control-input" id="location-check-8" checked>
                            <label class="custom-control-label" for="location-check-8"></label>
                          </div>
                        </div>
                      </div>
                    </div>
                    <div class="list-group-item">
                      <div class="row align-items-center">
                        ...
                        <div class="col-auto">
                          <div class="custom-control custom-checkbox">
                            <input type="checkbox" class="custom-control-input" id="location-check-9" checked>
                            <label class="custom-control-label" for="location-check-9"></label>
                          </div>
                        </div>
                      </div>
                    </div>
              ...
              <!-- Reset button -->
              <div class="p-4">
                <button type="button" class="btn btn-block btn-primary">Reset filters</button>
              </div>
            </div>
            <div class="col-lg-7 col-xl-8 order-lg-1">
              <div id="map-default" class="map-canvas rounded-0" data-lat="37.7767964" data-lng="-122.4187928" style="height: 770px;" data-color="#caa7f9"></div>
            </div>
          </div>
        </div>
      </div>
