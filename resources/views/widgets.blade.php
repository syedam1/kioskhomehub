  ...
  <div class="container-fluid container-application">
    ...
    <div class="sidenav" id="sidenav-main">
      ...
      <div class="nav-application clearfix">
        ...
        <a href="../application/widgets.blade.php" class="btn btn-square text-sm active">
          ...
          <div class="row justify-content-between align-items-center">
            <div class="col-md-6 d-flex align-items-center justify-content-between justify-content-md-start mb-3 mb-md-0">
              ...
              <div class="d-inline-block">
                <h5 class="h4 d-inline-block font-weight-400 mb-0 text-white">Widgets</h5>
              </div>
              <!-- Additional info -->
            </div>
          ...
          <div class="col-xl-3 col-md-6">
            <div class="card card-stats">
              ...
              <div class="card-body">
                <div class="row">
                  <div class="col">
                    <h6 class="text-muted mb-1">Finished tasks</h6>
            ...
            <div class="card-header">
              <div class="d-flex align-items-center">
                ...
                <div class="avatar-content ml-3">
                  ...
                  <span class="text-sm text-muted"><i class="fas fa-calendar mr-2"></i>3 Sep, 19</span>
                </div>
              </div>
            </div>
            <div class="card-body">
          ...
          <div class="card">
            ...
            <div class="card-header py-2">
              <form>
                <div class="input-group input-group-merge input-group-flush">
                  <div class="input-group-prepend">
                    <span class="input-group-text bg-transparent pl-0"><i class="fas fa-search"></i></span>
                  </div>
                  <input type="text" class="form-control form-control-flush" placeholder="Type and hit enter ...">
                  <div class="input-group-append">
                    <button type="reset" class="input-group-text pr-0 bg-transparent"><i class="fas fa-times"></i></button>
                  </div>
                </div>
              </form>
            </div>
