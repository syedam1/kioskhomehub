...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <link rel="icon" href="http://kioskhomehub.com/images/kiosk-icon-128.png">
        <link rel="stylesheet" href="https://stackpath.bootstrapcdn.com/bootstrap/4.5.2/css/bootstrap.min.css" integrity="sha384-JcKb8q3iqJ61gNV9KGb8thSsNjpSL0n8PARn9HuZOnIxN0hoP+VmmDGMN5t9UJ0Z" crossorigin="anonymous">
        <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/animate.css/4.0.0/animate.min.css">
        <link rel="stylesheet" href="http://kioskhomehub.com/css/style.css">
...
<div class="content-container text-center">
  <img class="logo" src="http://kioskhomehub.com/images/kiosk-white.svg" alt="Kiosk logo">
...
<div class="footer">
  <p class="text-light m-0">eTender Inc <script>document.write(new Date().getFullYear())</script>2020</p>
...
<div class="ui">
  ...
  <p>Alive: <span class="alive">188</span></p>
  <p>Drawn: <span class="drawn">188</span></p>
  <p><span class="fps">264</span> FPS</p>
  <a class="save" href="" download="http://kioskhomehub.com/capture.png">Save</a>
</div>
...
<script src="http://kioskhomehub.com/js/background.js"></script>
<script src="http://kioskhomehub.com/js/code-unlock.js"></script>
<script src="http://kioskhomehub.com/js/script.js"></script>
<script src="https://kit.fontawesome.com/a31d2b5107.js" crossorigin="anonymous"></script>



<canvas width="1875" height="918"></canvas>
            </div>
        </div>
    </body>
</html>
